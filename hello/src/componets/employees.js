...
function Employee(props) {
  return (
    <div className='min-w-[350px] max-w-[350px] py-8 px-8 max-w-sm m-2 space-y-2 bg-white rounded-xl shadow-lg sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:gap-x-6'>
      <img
